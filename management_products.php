...
$sql = "SELECT pm.*, c.category FROM product_management pm JOIN category c ON pm.id_category = c.id_category";
                    ...
                    <div class="card-body">
                      ...
                      <table class="table table-borderless table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?= $no++; ?></td>
                            <td class="text-capitalize"><?= $data['product_name'] ?></td>
                            <td><?= $data['category'] ?></td>
                            <td><?= $data['stock'] ?></td>
                            ...
                            <td>
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="edit_products.php?id=<?= $data['id']; ?>">Ubah</a>
